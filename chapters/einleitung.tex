...
Am Anfang des 5. Schuljahres bat uns unser \acs{fi}-Professor DI(FH) Mario Prantl an, dieses Projekt durch eine Smartphone-App und eine Hardware-Überarbeitung zu verbessern.
...
\paragraph{Matthias Mair} is verantwortlich für die Hardware-Überarbeitung der Station.
Im Zuge dieser sollen die vielen Einzelmodule in einer übersichtlichen Platine vereint werden.
Für die Leiterplatte soll die weit verbreitete SMD-Technologie verwendet werden, da diese heutzutage Marktstandard für integrierte Geräte ist.
