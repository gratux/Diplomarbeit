...
\begin{table}
    ...
    \caption{Anfrage-Arten des \ac{rtsp}-Protokolls}
    \label{tab:rtsp-req}
\end{table}
...
Die LibVLC-Sharp-Bindings ermöglichen die Verwendung des \ac{mvvm}-Modells, welches vom \ac{wpf}- und Silverlight-Architekten John Gossman im Jahr 2005 auf seinem Blog vorgestellt wurde. \cite[vlg.][The Evolution of Model-View-ViewModel]{msdoc-mvvm}
...
Das GitHub-Repository des Zusatzmoduls beinhält einige Beispielapplikationen, darunter auch \texttt{test-launch}.
Dieses Anwendungsbeispiel nimmt ähnlich wie \texttt{gst-launch-1.0} als Kommandozeilenargument eine GStreamer-Pipeline an.
