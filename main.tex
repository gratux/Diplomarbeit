...
\usepackage[margin=2cm, bindingoffset=10mm, includeheadfoot]{geometry}
\usepackage[british, german]{babel}
\usepackage[hyperref=true]{acro}
\usepackage[backend=biber, style=ieee]{biblatex}
\usepackage{fancyhdr, graphicx, datetime2, fontspec, tikz, float, hologo, csquotes, tabulary, listings, longtable}
